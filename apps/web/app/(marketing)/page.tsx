...
const operatingMoments = [
  {
    ...
    body:
      'Go from sign-up link to a polished club website with a homepage, branded sections, and navigation that matches how your team actually works.',
    detail:
  ...
  },
  {
    ...
    body:
      'Roles, access, member directories, and project participation live in one place so new officers do not spend weeks rebuilding context.',
    detail:
  ...
  },
  {
    ...
    body:
      'Publish upcoming meetings, attach details, track participation, and keep members aligned without switching between forms, spreadsheets, and chat threads.',
    detail:
  ...
  },
  {
    ...
    body:
      'Share news, pin what matters, and keep your homepage fresh without asking someone to edit a site by hand every week.',
    detail:
...
const productAreas = [
  ...
  },
  {
    ...
    points: ['Sign-in and roles', 'Structured permissions', 'Safer admin workflows'],
  },
  {
    icon: BarChart3,
...
const lifecycleStages = [
  {
    ...
    items: ['Homepage and info pages', 'Officer access', 'Member onboarding path'],
  },
  {
  ...
  },
  {
    ...
    items: ['Persistent structure', 'Shared records', 'Faster officer transitions'],
  },
];
...
function SectionEyebrow({
  ...
  return (
    <div
      className={`inline-flex w-fit items-center rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium tracking-tight text-slate-700 shadow-sm dark:border-border/60 dark:bg-card dark:text-foreground ${className}`}
    >
      {children}
    </div>
  );
...
function Home() {
  return (
    <main className="bg-white text-slate-950 dark:bg-background dark:text-foreground">
      <div className="mt-4 flex flex-col space-y-24 py-14 md:space-y-28">
        ...
        <section className="container mx-auto">
          <FeatureShowcase
            ...
            icon={
              <FeatureShowcaseIconContainer className="rounded-xl border border-slate-200 bg-slate-50 text-slate-700 dark:border-border dark:bg-background">
          ...
          >
            <FeatureGrid>
              <FeatureCard
                className="relative col-span-1 overflow-hidden border-slate-200 bg-white text-center shadow-sm transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-border/60 dark:bg-card dark:text-card-foreground"
        ...
        <section className="border-y border-slate-200 bg-slate-50/70 py-10 dark:border-border dark:bg-muted/20">
          <div className="container mx-auto">
            <ScrollReveal>
              <div className="grid gap-6 lg:grid-cols-[0.72fr_1.28fr] lg:items-center">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm text-slate-700 sm:grid-cols-3 dark:text-muted-foreground">
                  {audienceSegments.map((segment) => (
                    <div
                      key={segment}
                      className="rounded-2xl border border-slate-200 bg-white px-4 py-4 shadow-sm dark:border-border/60 dark:bg-card dark:text-foreground"
                    >
                      {segment}
                    </div>
                  ))}
        ...
        <section id="platform" className="container mx-auto">
          <ScrollReveal>
            <div className="max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-8 text-slate-600 dark:text-muted-foreground">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:gap-10">
            <ScrollReveal className="lg:sticky lg:top-28 lg:self-start">
              <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_35px_90px_-60px_rgba(15,23,42,0.25)] dark:border-border/60 dark:bg-card">
                <div className="rounded-[1.5rem] bg-slate-50 p-5 dark:bg-muted/30">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-xs font-semibold uppercase tracking-[0.28em] text-slate-500 dark:text-muted-foreground">
                        GoClub flow
                      </div>
                    ...
                    <div className="rounded-2xl bg-white p-3 shadow-sm dark:bg-background/80">
                  ...
                  <div className="mt-6 space-y-3">
                    {[
                      ...
                      <div
                        key={step}
                        className="flex items-center gap-3 rounded-2xl bg-white px-4 py-4 shadow-sm dark:bg-background/80"
                      >
                        <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#edf4ff] text-sm font-semibold text-[#4189e2] dark:bg-primary/15">
                          0{index + 1}
                        </span>
              ...
              {operatingMoments.map((item, index) => {
                ...
                return (
                  <ScrollReveal key={item.title} delay={index * 80}>
                    <article className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_35px_80px_-65px_rgba(15,23,42,0.24)] dark:border-border/60 dark:bg-card">
                      <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                        <div className="max-w-2xl">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#edf4ff] dark:bg-primary/15">
                        ...
                        <div className="max-w-sm rounded-2xl bg-slate-50 p-5 text-sm leading-7 text-slate-700 dark:bg-muted/30 dark:text-muted-foreground">
                          {item.detail}
                        </div>
                      </div>
                    </article>
        ...
        <section className="container mx-auto">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.96fr] lg:items-center">
            <ScrollReveal>
              <div className="max-w-3xl">
                ...
                <div className="mt-10 grid gap-4 sm:grid-cols-2">
                  {[
                    ['Shared operations', 'A public website and internal workspace built from the same source.'],
                    ['Officer clarity', 'Everyone knows where updates, roles, and records live.'],
                    ['Less rework', 'Teams stop rewriting the same event information across tools.'],
                    ['More continuity', 'New leadership inherits a system, not a scramble.'],
                  ].map(([title, copy], index) => (
                    <ScrollReveal key={title} delay={120 + index * 60}>
                      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 dark:border-border/60 dark:bg-muted/30">
                        <div className="text-base font-semibold text-slate-950 dark:text-white">
                          {title}
                        </div>
                        <div className="mt-2 text-sm leading-6 text-slate-600 dark:text-muted-foreground">
                          {copy}
                        </div>
                      </div>
                    </ScrollReveal>
            ...
            <ScrollReveal delay={140}>
              <div className="rounded-[2rem] border border-slate-200 bg-white p-4 shadow-[0_40px_100px_-70px_rgba(15,23,42,0.35)] dark:border-border/60 dark:bg-card">
                <div className="rounded-[1.6rem] border border-slate-200 bg-slate-50 p-4 dark:border-border/60 dark:bg-muted/30">
                  <div className="flex items-end justify-between gap-4 border-b border-slate-200 pb-4 dark:border-border/60">
                    <div>
                      <div className="text-xs uppercase tracking-[0.28em] text-slate-500 dark:text-muted-foreground">
                        Interface preview
                      </div>
                  ...
                  <div className="mt-4 overflow-hidden rounded-[1.35rem] border border-slate-200 bg-white dark:border-border/60 dark:bg-card">
                    <Image
                  ...
                  <div className="mt-4 grid gap-3 md:grid-cols-2">
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-border/60 dark:bg-card">
                      <div className="text-xs uppercase tracking-[0.24em] text-slate-500 dark:text-muted-foreground">
                        Surface one
                      </div>
                      <div className="mt-2 text-sm leading-6 text-slate-600 dark:text-muted-foreground">
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-border/60 dark:bg-card">
                      ...
                      <div className="mt-2 text-sm leading-6 text-slate-600 dark:text-muted-foreground">
                        The internal workspace gives leadership the tools to keep
                        the site and the operation in sync.
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {productAreas.map((area, index) => {
              ...
              return (
                <ScrollReveal key={area.name} delay={index * 80}>
                  <article className="flex h-full flex-col rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_35px_90px_-75px_rgba(15,23,42,0.3)] dark:border-border/60 dark:bg-card">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#edf4ff] dark:bg-primary/15">
                    ...
                    <div className="mt-8 space-y-3">
                      {area.points.map((point) => (
                        <div
                          key={point}
                          className="flex items-center gap-3 rounded-2xl bg-slate-50 px-4 py-4 text-sm font-medium text-slate-700 dark:bg-muted/30 dark:text-foreground"
                        >
        ...
        <section className="container mx-auto">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-10">
            <ScrollReveal className="lg:sticky lg:top-28 lg:self-start">
              <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-8 dark:border-border/60 dark:bg-muted/30">
                <SectionEyebrow>
                  Full-season rhythm
                </SectionEyebrow>
                ...
                <div className="mt-8 border-t border-slate-200 pt-6 dark:border-border/60">
                  <Button
                    asChild
                    size="lg"
                ...
                <ScrollReveal key={stage.title} delay={index * 90}>
                  <article className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_35px_80px_-65px_rgba(15,23,42,0.24)] dark:border-border/60 dark:bg-card">
                    <div className="grid gap-6 md:grid-cols-[0.9fr_1.1fr] md:items-start">
                      <div>
                        <div className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500 dark:text-muted-foreground">
                          Phase 0{index + 1}
                        </div>
                      ...
                      <div className="space-y-3">
                        {stage.items.map((item) => (
                          <div
                            key={item}
                            className="rounded-2xl bg-slate-50 px-4 py-4 text-sm font-medium text-slate-700 dark:bg-muted/30 dark:text-foreground"
                          >
                            {item}
                          </div>
                        ))}
        ...
        <section className="border-y border-slate-200 bg-slate-50/70 py-24 md:py-28 dark:border-border dark:bg-muted/20">
          <div className="container mx-auto">
            <ScrollReveal>
                  ...
                  {systemBenefits.map((benefit, index) => {
                    ...
                    return (
                      <ScrollReveal
                        ...
                        delay={120 + index * 70}
                      >
                        <div className="flex gap-4 rounded-[1.75rem] border border-slate-200 bg-white p-6 dark:border-border/60 dark:bg-card">
                          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#edf4ff] dark:bg-primary/15">
                          ...
                          <div>
                            ...
                            <div className="mt-2 text-sm leading-7 text-slate-600 dark:text-muted-foreground">
                              {benefit.text}
                            </div>
                          </div>
                        </div>
        ...
        <section className="container mx-auto">
          <ScrollReveal>
            <div className="relative overflow-hidden rounded-[2.5rem] border border-slate-200 bg-white px-8 py-12 md:px-12 md:py-14 dark:border-border/60 dark:bg-card">
              <div className="absolute right-0 top-0 h-56 w-56 rounded-full bg-[#4189e2]/10 blur-3xl" />
              ...
              <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
                <div className="max-w-3xl">
                  ...
                  <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600 dark:text-muted-foreground">
                    ...
                    theme stays white. The extra motion and depth now support the
                    original design instead of replacing it.
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-4 sm:flex-row lg:flex-col">
                  ...
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="h-12 rounded-xl border-slate-300 bg-white px-6 text-base text-slate-950 hover:bg-slate-50 dark:border-border/60 dark:bg-background dark:text-white dark:hover:bg-muted/40"
                  >
  ...
  return (
    <Hero
      title={
        <>
          <span className="block text-slate-950 dark:text-white">
            The <span className="font-semibold text-[#4189e2]">all-in-one platform</span>
          </span>
          <span className="block text-slate-950 dark:text-white">
            for your club&apos;s website
          </span>
        </>
      }
      subtitle={
      ...
      image={
        <Image
          priority
          className="rounded-2xl border border-slate-200 dark:border-primary/10"
