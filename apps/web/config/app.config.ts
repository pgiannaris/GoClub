...
const AppConfigSchema = z
  .object({
    name: z
      .string({
        description: `This is the name of your product. Ex. "GoClub"`,
        required_error: `Please provide the variable NEXT_PUBLIC_PRODUCT_NAME`,
      })
      .min(1),
    title: z
      .string({
        description: `This is the default title tag of your product.`,
        required_error: `Please provide the variable NEXT_PUBLIC_SITE_TITLE`,
      })
      .min(1),
    description: z.string({
      description: `This is the default description of your product.`,
    ...
    locale: z
      .string({
        description: `This is the default locale of your product.`,
